...
export const setSpeakersData = (payload: FetchSpeakersSuccessPayload): FetchSpeakersSuccess => ({
    type: speakersTypes.FETCH_SPEAKERS_SUCCESS,
    payload,
});

export const fetchSpeakersFailure = (payload: FetchSpeakersFailurePayload): FetchSpeakersFailure => ({
